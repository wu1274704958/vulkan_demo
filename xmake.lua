...
add_requires("stb","glm","vulkan-hpp","vulkan-loader","glfw","mini-test","assimp","spirv-tools","glslang")
set_languages("c17", "c++20")
add_includedirs("include/","include/res_loader/") 
add_packages("stb","glm","vulkan-hpp","vulkan-loader","glfw","mini-test","assimp","spirv-tools","glslang")
