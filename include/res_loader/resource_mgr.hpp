...
namespace gld{    
    ...
    public:
		...
		PathTy as_path(const char* uri) const
		{
			return PathTy(uri);
		}
            ...
            ->typename MapResPlug<static_cast<size_t>(Rt),Plugs...>::type::RetTy
        {
            ...
            auto key = as_path(std::forward<Uri>(uri));
            ...
            auto [success,res] = Ty::load(VKD_RES_MGR_CXT_VAR_NAME_WITH_COMMA path,key,std::forward<typename Ty::ArgsTy>(args));
            ...
            ->typename MapResPlug<static_cast<size_t>(Rt), Plugs...>::type::RetTy
        {
            ...
            if constexpr(!std::is_same_v<ARGS_T,void>)
            {
                ...
                auto [success,res] = Ty::load(VKD_RES_MGR_CXT_VAR_NAME_WITH_COMMA path,key);
    ...
    protected:
        ...
        PathTy root;
#endif
        VKD_RES_MGR_CXT_PTR_TYPE VKD_RES_MGR_CXT_VAR_NAME_WITH_SEM
...
private:    
    inline static std::shared_ptr<ResourceMgr<Separator,Plugs...>> self;
        ...
        ResourceMgr<Separator,Plugs...>(std::shared_ptr<EGLCxt> mgr)
        {
            ...
            this->VKD_RES_MGR_CXT_VAR_NAME = std::move(mgr);
        }
#endif
    };
